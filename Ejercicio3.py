...
payasos = int(input("Ingrese la cantidad de payasos vendidos en el último pedido: "))
munecas = int(input("Ingrese la cantidad de muñecas vendidas en el último pedido: "))

peso = (112*payasos)+(75*munecas)
print("El peso total del pedido es de " + str(peso) + " gramos")
